...
class wablas{
    ...
    public function __construct() {
        ...
        $this->token = "K8ezHUpicFAOcP2TPCD8NgwWj8dUMXoRGUdaHJLQKelC740cySxCtkJ2MmURY3ke";
    }
    ...
    function simple_wa($phone, $message){
        $result = file_get_contents("https://ampel.wablas.com/api/send-message?token=".$this->token."&phone=".$phone."&message=".$message);
        echo "<pre>";
        print_r($result);
    }
