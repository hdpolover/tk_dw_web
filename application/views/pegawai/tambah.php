    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" action="<?= base_url('pegawai/simpan'); ?>">
                ...
                <div class="form-group row">
                    <label for="masa_kerja" class="col-sm-4 col-form-label">Masa Kerja</label>
                    <div class="col-sm-8">
                        <input type="text" name="masa_kerja" class="form-control" id="masa_kerja" placeholder="Masukan masa kerja pegawai">
                    </div>
                </div>
                <div class="form-group row">
